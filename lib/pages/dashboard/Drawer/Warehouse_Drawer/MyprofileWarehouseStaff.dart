...
class WarehouseStaffMyProfilePage extends StatelessWidget {
  // Dummy data for demonstration purposes
  final String userName = 'John Doe';
  final String email = 'johndoe@example.com';
  final String phoneNumber = '+1234567890';
  final String position = 'Warehouse Staff';
  final String responsibilities = 'Managing inventory, picking and packing orders, and maintaining warehouse organization.';

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Warehouse Staff Profile'),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildProfileInfoCard('Position', position, Icons.work),
              ...
              SizedBox(height: 10),
              _buildActivityLogCard('Updated inventory levels', '2 hours ago'),
              _buildActivityLogCard('Picked orders for shipment', '1 day ago'),
              _buildActivityLogCard('Organized warehouse layout', '3 days ago'),
              SizedBox(height: 20),
